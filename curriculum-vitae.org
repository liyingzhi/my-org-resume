...
# #+LATEX_HEADER: \usepackage[backend=bibtex,style=trad-abbrv,sorting=none,sortcites=true,doi=false,url=false,giveninits=true]{biblatex}
#+LATEX_HEADER: \usepackage[backend=biber,style=trad-abbrv,sorting=none,sortcites=true,doi=false,url=false,giveninits=true]{biblatex}
#+LATEX_HEADER: \DeclareNameAlias{sortname}{given-family}
#+LATEX_HEADER: \addbibresource{aidan.bib}
...
% \divider
\printbibliography[title={\printinfo{\faUsers}{Conference Proceedings}},type=inproceedings]
#+end_export
